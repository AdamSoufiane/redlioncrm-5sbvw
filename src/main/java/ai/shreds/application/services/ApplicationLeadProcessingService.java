package ai.shreds.application.services; 
         ...
         leads.stream() 
             ...
             .forEach(lead -> { 
                 try { 
                     ...
                     logger.logError("Failed to process lead: " + lead.getId() + ", Specific Error: " + e.getMessage()); 
                 } catch (Exception e) { 
                     logger.logError("Failed to process lead: " + lead.getId() + ", General Error: " + e.getMessage()); 
                 } 
             }); 
 ...
 // Note: Use Lombok annotations for getters and setters in DomainLeadEntity.